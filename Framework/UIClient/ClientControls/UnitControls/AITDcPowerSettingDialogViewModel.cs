...
{
    public class AITDcPowerSettingDialogViewModel : DialogViewModel<string>, INotifyPropertyChanged
    {
        public AITDcPowerSettingDialogViewModel(string dialogName = "")
        {
        ...
        public string InputFrequency
        {
            ...
            {
                _setFrequency = value;
                NotifyOfPropertyChange(nameof(InputFrequency));
                NotifyOfPropertyChange(nameof(IsEnableSet));
            }
        }
        ...
        public string SetPointWithUnit
        {
            get
            {
                if (DeviceData == null)
                    ...
                    return $"SetPoint ({DeviceData.UnitPower}) :";
            }
        }
        ...
        {
            InvokeClient.Instance.Service.DoOperation($"{DeviceData.Module}.{DeviceData.DeviceName}.{AITRfOperation.SetPulseFrequency}", InputFrequency);
