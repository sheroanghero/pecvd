...
{
    public class AITDxkdpDcPowerSettingDialogViewModel : DialogViewModel<string>, INotifyPropertyChanged
    {
        public AITDxkdpDcPowerSettingDialogViewModel(string dialogName = "")
        {
        ...
        public bool IsEnableSet
        {
            get
            {
                return float.Parse(InputSetPoint) <= DeviceData.ScaleCurrent;
            }
        }
        ...
        public string SetPointWithUnit
        {
            get
            {
                if (DeviceData == null)
                    ...
                    return $"SetCurrent ({DeviceData.UnitCurrent}) :";
            }
        }
