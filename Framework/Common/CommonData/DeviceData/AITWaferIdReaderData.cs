...
namespace Aitex.Core.Common.DeviceData
{
    [DataContract]
    [Serializable]
    public class AITWaferIdReaderData : INotifyPropertyChanged, IDeviceData
    {
    ...
    public class AITWaferIdReaderOperation
    {
        public const string TrigOn = "TrigOn";
        public const string TrigOff = "TrigOff";
    }

    public class AITWaferIdReaderPropertyName
    {
