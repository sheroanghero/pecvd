...
namespace MECF.Framework.RT.EquipmentLibrary.HardwareUnits.Degas
{
    public class Degas : BaseDevice, IDevice, IDegas
    {
        ...
        public Degas(string module, int slotCount) : base(module, module, module, module)
        {
            //WaferManager.Instance.SubscribeLocation(module, slotCount);
            EnableLift = true;
        }

        public Degas(string module):this(module, SlotCount)
        {
