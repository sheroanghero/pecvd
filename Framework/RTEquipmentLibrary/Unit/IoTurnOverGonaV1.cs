...
namespace Aitex.Core.RT.Device.Unit
{
    ...
    /// 
    /// </summary>
    public class IoTurnOverGonaV1 : FlipperBaseDevice
    {
        ...
        public IoTurnOverGonaV1(string module, XmlElement node, string ioModule = ""):base(node.GetAttribute("module"), node.GetAttribute("id"))
        {
