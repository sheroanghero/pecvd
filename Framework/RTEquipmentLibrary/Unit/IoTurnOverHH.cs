...
namespace Aitex.Core.RT.Device.Unit
{
    ...
    /// 
    /// </summary>
    public class IoTurnOverHH : FlipperBaseDevice
    {
        ...
        private readonly DIAccessor _diOnTarget;

        private readonly DIAccessor _diAlarm;
        private readonly DIAccessor _diLeftLimit;
        private readonly DIAccessor _diRightLimit;
        ...
        private readonly DOAccessor _doRequestM0;
        ...
        private readonly DOAccessor _doJogFwd;
        private readonly DOAccessor _doJogRev;
        ...
        public IoTurnOverHH(string module, XmlElement node, string ioModule = ""):base(node.GetAttribute("module"), node.GetAttribute("id"))
        {
            ...
            _diOnTarget = ParseDiNode("DI_TurnOverOnTarget", node, ioModule);
            _diAlarm = ParseDiNode("DI_TurnOverAlarm", node, ioModule);
            _diLeftLimit = ParseDiNode("DI_TurnOverLeftLimit", node, ioModule);
            _diRightLimit = ParseDiNode("DI_TurnOverRightLimit", node, ioModule);
            ...
            _doRequestM0 = ParseDoNode("DO_TurnOverM0", node, ioModule);
            _doRequest0Degree = ParseDoNode("DO_TurnOverRequest0Degree", node, ioModule);
            _doRequest180Degree = ParseDoNode("DO_TurnOverRequest180Degree", node, ioModule);
            ...
            _doJogFwd = ParseDoNode("DO_TurnOverJogFwd", node, ioModule);
            _doJogRev = ParseDoNode("DO_TurnOverJogRev", node, ioModule);           
        ...
        public bool InitializeIoTurnover()
        {
            ...
            DATA.Subscribe($"{Module}.{Name}.IsBusy", () => _diOnTarget.Value);
            ...
            DATA.Subscribe($"{Module}.{Name}.IsPressureError", () => _diPressureError.Value);
        ...
        protected override bool fStartHome(object[] param)
        {
            ...
            if(_doRequestM0 !=null)
                _doRequestM0.SetValue(false, out _);
        ...
        protected override bool fMonitorTurnTo0(object[] param)
        {
            ...
            if(!_di0Degree.Value && _di180Degree.Value && _diReady.Value && _diOnTarget.Value)
            {
                _doStop.SetValue(false, out _);
                _doRequest0Degree.SetValue(false, out _);
                _doRequest180Degree.SetValue(false, out _);
