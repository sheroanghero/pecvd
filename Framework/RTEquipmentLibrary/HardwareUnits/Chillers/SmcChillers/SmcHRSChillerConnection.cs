...
{
    //Modbus RTU
    public class SmcHRSChillerConnection : SerialPortConnectionBase
    {
        public SmcHRSChillerConnection(string portName, int baudRate = 19200, int dataBits = 7, Parity parity = Parity.Even, StopBits stopBits = StopBits.One)
