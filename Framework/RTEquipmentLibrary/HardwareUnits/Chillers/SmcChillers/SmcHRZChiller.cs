...
{
    [Serializable]
    public class SmcHRZChiller : ChillerBase, IConnection
    {
        ...
        private SmcHRZChillerConnection _connection;
        public SmcHRZChillerConnection Connection
        {
        ...
        public SmcHRZChiller(string module, string name, string scRoot) : base()
        {
            _scRoot = scRoot;
            base.Module = module;
            base.Name = name;
        ...
        public override bool Initialize()
        {
            ...
            _connection = new SmcHRZChillerConnection(_address);
        ...
        public bool Initialize(string portName, int baudRate = 9600, int dataBits = 8, Parity parity = Parity.None, StopBits stopBits = StopBits.One)
        {
            ...
            _connection = new SmcHRZChillerConnection(portName, baudRate, dataBits, parity, stopBits);
            _connection.EnableLog(_enableLog);
        ...
        public   void QueryAllTemp()
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new SmcHRZChillerGetStatusHandler(this));
            }
        }
        ...
        public override void SetChillerCH1OnOff(bool isOn)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new SmcHRZChillerSetOnOffHandler(this,  isOn));
            }
        }
        ...
        public override void SetChillerCH1Temperature(float temp)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new SmcHRZChillerSetTemperatureHandler(this, temp));
            }
        }
