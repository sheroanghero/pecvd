...
namespace MECF.Framework.RT.EquipmentLibrary.HardwareUnits.DCPowers.AE
{
    ...
    public class AeDcPowerConnection : SerialPortConnectionBase
    {
        private List<byte> _lstCacheBuffer = new List<byte>();

        public AeDcPowerConnection(string portName, int baudRate = 19200, int dataBits = 8, Parity parity = Parity.Odd, StopBits stopBits = StopBits.One)
