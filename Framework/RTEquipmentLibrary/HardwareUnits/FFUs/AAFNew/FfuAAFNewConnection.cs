...
namespace MECF.Framework.RT.EquipmentLibrary.HardwareUnits.FFUs.AAF
{
    ...
    public class FfuAAFNewConnection : SerialPortConnectionBase
    {
        private List<byte> _lstCacheBuffer = new List<byte>();
        public FfuAAFNewConnection(string portName) : base(portName,9600,8, System.IO.Ports.Parity.None, System.IO.Ports.StopBits.One,"\r",false)
        {
