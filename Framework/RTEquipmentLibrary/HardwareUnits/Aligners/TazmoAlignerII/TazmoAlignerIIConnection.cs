...
{
    public class TazmoAlignerIIMessage:AsciiMessage
    {
        public string Data { get; set; }
    }
    public class TazmoAlignerIIMessageBIN:BinaryMessage
    {
        public byte[] CMD { get; set; }
        public byte[] Data { get; set; }
    }

    public class TazmoAlignerIIConnection: SerialPortConnectionBase
    {
        private List<byte> _lstCacheBuffer = new List<byte>();

        public TazmoAlignerIIConnection(string portName, int baudRate = 9600, int dataBits = 8, Parity parity = Parity.None, StopBits stopBits = StopBits.One)
        ...
        protected override MessageBase ParseResponse(byte[] rawBuffer)
        {
            ...
            TazmoAlignerIIMessageBIN msg = new TazmoAlignerIIMessageBIN();
