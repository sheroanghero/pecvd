...
namespace MECF.Framework.RT.EquipmentLibrary.HardwareUnits.Aligners.YaskawaAligner
{
    ...
    public class YaskawaNxcAlignerMessage : AsciiMessage
    {
    ...
    public class YaskawaNxcAlignerConnection : TCPPortConnectionBase
    {
        private YaskawaNxcAligner _aligner;
        public YaskawaNxcAlignerConnection(YaskawaNxcAligner pa, string ipaddress)
        ...
        {
            YaskawaNxcAlignerMessage msg = new YaskawaNxcAlignerMessage();
            try
            {
                ...
                if (_aligner.IsEnableSeqNo)
                {
                    ...
                    if (msg.IsAck)
                    {
                        ...
                        if (msg.Ackcd != "0000")
                        {
                            _aligner.OnError($"Execution error,Ack code is {msg.ErrorCode}");
                        }
                    }
                    if (msg.IsComplete)
                    {
                        ...
                        {
                            _aligner.OnError($"Execution error,Error code is {msg.ErrorCode}");
                        }
                    }
        ...
        {
            YaskawaNxcAlignerMessage evt = msg as YaskawaNxcAlignerMessage;
