...
{
    public class TDKB200LoadPortHandler : HandlerBase
    {
        public TDKB200LoadPort Device { get; set; }
        public string Command;
        protected TDKB200LoadPortHandler(TDKB200LoadPort device, string command, string para) : base(BuildMesage(command, para))
        {
            Device = device;
            Command = command;
            Name = command;
        ...
        {
            TDKB200LoadPortMessage response = msg as TDKB200LoadPortMessage;
            ResponseMessage = msg;
    ...
    public class TDKB200SetHandler : TDKB200LoadPortHandler
    {
        private string setcommand;
        public TDKB200SetHandler(TDKB200LoadPort device, string command, string para) : base(device, BuildData(command), para)
        {
            setcommand = command;
        }
    ...
    public class TDKB200GetHandler : TDKB200LoadPortHandler
    {
        public TDKB200GetHandler(TDKB200LoadPort device, string command, string para) : base(device, BuildData(command), para)
        {
    ...
    public class TDKB200ModHandler : TDKB200LoadPortHandler
    {
        public TDKB200ModHandler(TDKB200LoadPort device, string command, string para) : base(device, BuildData(command), para)
        {
    ...
    public class TDKB200MoveHandler : TDKB200LoadPortHandler
    {
        private string moveCommand;
        public TDKB200MoveHandler(TDKB200LoadPort device, string command, string para) : base(device, BuildData(command), para)
        {
            moveCommand = command;
        }
        private static string BuildData(string command)
