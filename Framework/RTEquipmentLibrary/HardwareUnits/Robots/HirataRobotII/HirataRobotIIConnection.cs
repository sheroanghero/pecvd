...
{
    public class HirataRobotIIMessage : AsciiMessage
    {
        public string Data { get; set; }
        public string ErrorText { get; set; }
    }

    public class HirataRobotIIConnection : SerialPortConnectionBase
    {
        ...
        private HirataRobotII _robot;

        public HirataRobotIIConnection(string portName, HirataRobotII robot=null,int baudRate = 19200, int dataBits = 7, Parity parity = Parity.Even, StopBits stopBits = StopBits.One)
        ...
        protected override MessageBase ParseResponse(byte[] rawBuffer)
        {
            ...
            HirataRobotIIMessage msg = new HirataRobotIIMessage();
            ...
            if (temps[temps.Length - 2] != 0x3 && !_robot.isSimulatorMode) return msg;
