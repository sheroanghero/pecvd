...
{
    public class MksRfMatch : RfMatchBase
    {
        ...
        public MksRfMatchConnection Connection
        {
            get { return _connection; }
        }

        private MksRfMatchConnection _connection;
        ...
        public MksRfMatch(string module, string name) : base(module, name)
        {
        ...
        public override bool Initialize()
        {
            ...
            _connection = new MksRfMatchConnection(portName, bautRate, dataBits, parity, stopBits);
            ...
            try
            {
                ...
                if (!_connection.IsBusy)
                {
                    lock (_locker)
                    {
                        ...
                        {
                            _lstHandler.AddLast(new MksRfMatchQueryStatusHandler(this, _deviceAddress));
                        }
        ...
        public override void SetPreSetsAndTrajectories1(Presets presets)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetPresetHandler(this, _deviceAddress, 1, presets));
            }
        }
        ...
        public override void SetPreSetsAndTrajectories2(Presets presets)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetPresetHandler(this, _deviceAddress, 2, presets));
            }
        }
        ...
        public override void SetActivePresetNo1(int presetNumber)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetActivePresetHandler(this, _deviceAddress, 1, presetNumber));
            }
        }
        ...
        public override void SetActivePresetNo2(int presetNumber)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetActivePresetHandler(this, _deviceAddress, 2, presetNumber));
            }
        }
        ...
        public override void EnablePreset1(bool enable)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchEnablePresetHandler(this, _deviceAddress, 1, enable));
            }
        }
        ...
        public override void EnablePreset2(bool enable)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchEnablePresetHandler(this, _deviceAddress, 2, enable));
            }
        }
        ...
        public override void EnableCapacitorMove1(bool enable)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchEnableCapMoveHandler(this, _deviceAddress, 1, enable));
            }
        }
        ...
        public override void EnableCapacitorMove2(bool enable)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchEnableCapMoveHandler(this, _deviceAddress, 2, enable));
            }
        }
        ...
        public override void SetTuneMode1(EnumRfMatchTuneMode mode)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetControlModeHandler(this, _deviceAddress, 1, mode));
            }
        }
        ...
        public override void SetTuneMode2(EnumRfMatchTuneMode mode)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetControlModeHandler(this, _deviceAddress, 2, mode));
            }
        }
        ...
        public override void SetLoad1(float position)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetLoadPositionHandler(this, _deviceAddress, 1, position));
            }
        }
        ...
        public override void SetLoad2(float position)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetLoadPositionHandler(this, _deviceAddress, 2, position));
            }
        }
        ...
        public override void SetTune1(float position)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetTunePositionHandler(this, _deviceAddress, 1, position));
            }
        }
        ...
        public override void SetTune2(float position)
        {
            lock (_locker)
            {
                _lstHandler.AddLast(new MksRfMatchSetTunePositionHandler(this, _deviceAddress, 2, position));
            }
        }
    }
