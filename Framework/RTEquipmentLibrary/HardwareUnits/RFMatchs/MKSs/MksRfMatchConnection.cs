...
{
    public class MksRfMatchMessage : BinaryMessage
    {
    ...
    public class MksRfMatchConnection : SerialPortConnectionBase
    {
        private List<byte> _lstCacheBuffer = new List<byte>();

        public MksRfMatchConnection(string portName, int baudRate = 9600, int dataBits = 8, Parity parity = Parity.None, StopBits stopBits = StopBits.One)
        ...
        protected override MessageBase ParseResponse(byte[] rawBuffer)
        {
            ...
            MksRfMatchMessage msg = new MksRfMatchMessage();
