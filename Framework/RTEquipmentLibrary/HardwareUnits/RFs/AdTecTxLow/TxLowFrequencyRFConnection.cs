...
{
    public class LowFrequencyRFMessage : BinaryMessage
    {
    ...
    public class LowFrequencyRFConnection : SerialPortConnectionBase
    {
        private List<byte> _lstCacheBuffer = new List<byte>();

        public LowFrequencyRFConnection(string portName, int baudRate = 9600, int dataBits = 8, Parity parity = Parity.None, StopBits stopBits = StopBits.One)
        ...
        protected override MessageBase ParseResponse(byte[] rawBuffer)
        {
            ...
            LowFrequencyRFMessage msg = new LowFrequencyRFMessage();
