...
namespace MECF.Framework.Simulator.Core.LoadPorts.Hirata
{
    ...
    public class HirataLoadPortSimulator : SerialPortDeviceSimulator
    {
...

        {
            ...
            _state[11] = "1"; //Wafer protrusion sensor 0 = Blocked. 1 = Unblocked.
            _state[12] = "0";
        ...
        private void ReceiveGetCommand(string cmdGet)
        {
            ...
            switch (cmdGet)
            {
                ...
                case "FSBxx":
                    ...
                    break;
                case "LPIOI":
                    FeedbackGetLPIOI(cmdGet);
                    break;
            }
        }

        private void FeedbackGetLPIOI(string cmd)
        {
            string message = Encoding.ASCII.GetString(BuildMesage($"ACK:{cmd}/1{InforPadState}25987F"));
