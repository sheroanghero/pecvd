...
{
    class TazmoRobotControllerSimulator : SocketDeviceSimulator
    {
        protected Random _rd = new Random();
        public bool Failed { get; set; }
        public string ResultValue { get; set; }

        public TazmoRobotControllerSimulator(int port)
          : base(port, 0, "\r", ',')
        {
            //Action Command
            ...
            //AddCommandHandler("UPL", HandleMTGO);//check Aix info
           ...
           // AddCommandHandler("MTP", HandleMTPT);
            ...
            */
            ...
            //AddCommandHandler("AEX", HandleCRSM);
