...
{   
    ...
    public class XyzPMSimulator : SocketDeviceSimulator
    {
        ...
        public XyzPMSimulator(int port)
            : base(port, -1,"\r", ' ')
        {
        ...
        protected override void ProcessUnsplitMessage(string msg)
        {
            ...
            switch(command)
            {
                case "Hello":
                    ...
                    break;
                case "RecipeList":
                    SendMessage("#RecipeList,0,Recipe1,Reipe2");
                    break;
                case "ModeLock":
                    SendMessage("#ModeLock,0");
                    break;
                case "EQToSafePosition":
                    SendMessage("#EQToSafePosition,0");
                    break;
                case "PrepareToReceiveWafer":
                    SendMessage("#PrepareToReceiveWafer,0");
                    break;
                case "PutWaferFinish":
                    SendMessage("#PutWaferFinish,0");
                    break;
                case "GetWaferFinish":
                    SendMessage("# GetWaferFinish,0");
                    Thread.Sleep(2000);
                    SendMessage("$Status,0,0,0");
                    break;
                case "ProcessWafer":
                    SendMessage("# ProcessWafer,0");
                    SendMessage("$PorcessStart, 0");
                    Thread.Sleep(2000);
                    SendMessage("$Status,0,1,1");
                    SendMessage("$ ProcessFinish,0, Result OK.");
                    SendMessage("$ $Status,0,1,0");
                    break;
