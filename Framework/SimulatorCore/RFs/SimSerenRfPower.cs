...
{
    class SimSerenRfPower : SerialPortDeviceSimulator
    {
        ...
        public SimSerenRfPower(string port)
            : base(port, -1, "\r", ' ', true)
        {
            ResultValue = "";
        ...
        protected override void ProcessUnsplitMessage(string message)
        {
            ...
            if (message == "Q\r")
            {
                OnWriteMessage("0300000 150 0 0 1000\r");
                return;
            }
