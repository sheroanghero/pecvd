...
namespace MECF.Framework.RT.Core.IoProviders.Siemens
{
    ...
    public class SiemensPPI : SerialDeviceBase<ReverseBytesTransform>
    {
        ...
        public override OperateResult<byte[]> Read( string address, ushort length )
        {
            ...
            // 验证
            if (read1.Content[0] != 0xE5) return new OperateResult<byte[]>( "PLC Receive Check Failed:" + SoftBasic.ByteToHexString( read1.Content, ' ' ) );
            ...
            // 错误码判断
            if (read2.Content.Length < 21) return new OperateResult<byte[]>( read2.ErrorCode, "Failed: " + SoftBasic.ByteToHexString( read2.Content, ' ' ) );
        ...
        public OperateResult<bool[]> ReadBool( string address, ushort length )
        {
            ...
            // 验证
            if (read1.Content[0] != 0xE5) return new OperateResult<bool[]>( "PLC Receive Check Failed:" + SoftBasic.ByteToHexString( read1.Content, ' ' ) );
            ...
            // 错误码判断
            if (read2.Content.Length < 21) return new OperateResult<bool[]>( read2.ErrorCode, "Failed: " + SoftBasic.ByteToHexString( read2.Content, ' ' ) );
        ...
        public override OperateResult Write( string address, byte[] value )
        {
            ...
            // 错误码判断
            if (read2.Content.Length < 21) return new OperateResult( read2.ErrorCode, "Failed: " + SoftBasic.ByteToHexString( read2.Content, ' ' ) );
